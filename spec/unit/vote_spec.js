...
describe("Vote", () => {
        ...
        Topic.create(
          {
            ...
            description:
              "A compilation of reports from recent visits to the start system",
            posts: [
              {
  ...
  describe('#create()', () => {
    ...
    it('should not create a vote with a value of more than one', done => {
      Vote.create({
        value: 3,
        postId: this.post.id,
        userId: this.user.id
    ...
    it('should not create a vote with a value of less than -1', done => {
      Vote.create({
        value: -231,
        postId: this.post.id,
        userId: this.user.id
